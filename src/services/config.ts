...
export const GFS_BASE = 'https://api.open-meteo.com/v1/gfs'
export const UKMO_BASE = 'https://api.open-meteo.com/v1/forecast'
...
export const IFS_MODEL = 'ecmwf_ifs'
export const GFS_MODEL = 'ncep_gfs_global'
export const UKMO_MODEL = 'ukmo_global_deterministic_10km'
...
export const ENV_CACHE_SCHEMA_VERSION = 5
