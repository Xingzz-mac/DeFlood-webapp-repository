...
function base(size: number, className: string): SvgBase {
  return {
    width: size,
    height: size,
    viewBox: '0 0 24 24',
...
export function IconDroplets({ size = 20, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
...
export function IconWaves({ size = 20, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
...
export function IconPhone({ size = 20, className = '' }: IconProps) {
  return (
    <svg {...base(size, className)}>
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 9a16 16 0 0 0 6.09 6.09l1.18-1.19a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
    </svg>
  )
}
